...
public class MissionStepTest {
    ...
    @DisplayName("데이터베이스가 연결되는지 확인한다.")
    @Test
    ...
    @DisplayName("DB에 저장된 예약 목록을 읽어올 수 있다.")
    @Test
    void get_reservations_to_db() {
    ...
    @DisplayName("DB에 예약을 추가하고 삭제할 수 있다.")
    @Test
    void add_reservation_and_delete_reservation() {
        Map<String, String> params = new HashMap<>();
        params.put("name", "브라운");
        params.put("date", "2023-08-05");
